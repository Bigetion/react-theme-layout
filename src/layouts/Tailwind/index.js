...
export default function Layout(props) {
  ...
  const [sidebarScrollTop, setSidebarScrollTop] = useState(lastSidebarScrollTop);
          ...
          <div className="topbar-container">
            <div className="topbar-inner">
              <div className="logo-container">
                <div className="logo-wrapper">
                  <a className="logo-link" href="/">
                    <svg viewBox="0 0 273 64" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="topbar-right">
                <button type="button" className="nav-button" onClick={() => setShowSidebar(!showSidebar)}>
                        ...
                        {!!item.children && (
                          <ul className="nav-list">
                            {item.children.map((item2, index2) => {
                              return (
                                <li key={`${index}${index2}`}>
                                  <a className="nav-link" href={`/${item2.path}`}>
                                    <span className="link-label">{item2.title}</span>
                                  </a>
                                </li>
                              );
                            })}
